...
const heroImages = [image1, image2, image5, image6, image8, image9, wifi];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2">
          ...
          <div className="p-4">
            <h1 className="text-5xl font-bold text-blue-800">
              Welcome to Kwetu Computers
            </h1>
            <p className="mt-4 text-lg text-gray-700">
              Empowering your business with innovative technology solutions.
              Discover our wide range of products and services designed to meet
